...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_DBManager_t, stringdata) + ofs \
...
const QMetaObject DBManager::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_DBManager.data,
      qt_meta_data_DBManager,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_DBManager.stringdata))
